  ...
  <main class="flex flex-col items-center justify-center w-screen h-screen bg-gray-200 text-gray-700">
      <form @submit.prevent="cekStatusPendaftaran" class="flex flex-col bg-white rounded shadow-lg p-12">
          <div class="flex justify-center">
              <h1 class="font-bold text-2xl">Check Registration status!</h1>
          </div>
          <div class="mt-6">
              ...
              <input
                  ...
                  type="email"
              />
              <label class="font-semibold text-xs mt-3" for="passwordField">Registration Status</label>
              <div
          ...
          <div class="flex mt-6 justify-center text-xs">
              <a class="text-blue-400 hover:text-blue-500" href="/">Back</a>
          </div>
      </form>
  </main>
</template>
  ...
  methods: {
      async cekStatusPendaftaran() {
          try {
              ...
              alert('There was an error while retrieving data: ' + error.message);
          }
      },
  },
};
